...
*/
BEGIN 
   EXECUTE IMMEDIATE 'DROP VIEW DBA_USER.NHANVIEN_KE_TOAN_VIEW';
   EXECUTE IMMEDIATE 'DROP VIEW DBA_USER.BENH_NHAN_BAC_SI_VIEW';
   EXECUTE IMMEDIATE 'DROP VIEW DBA_USER.ENCRYPTED_LUONG';
   EXCEPTION WHEN OTHERS THEN NULL;   
END;
/
BEGIN 
    DBMS_RLS.DROP_POLICY('DBA_USER','NHANVIEN','Read_above_7000000');
    EXCEPTION WHEN OTHERS THEN NULL; 
END;
/
/*
...
GRANT SELECT,UPDATE, INSERT ON DBA_USER.THUOC TO QUAN_LI_TAI_VU;
GRANT SELECT,UPDATE, INSERT ON DBA_USER.DICH_VU_KHAM_BENH TO QUAN_LI_TAI_VU;
...
GRANT SELECT ON DBA_USER.BENH_NHAN TO QUAN_LI_TAI_VU;
/
...
GRANT SELECT ON DBA_USER.DIEU_TRI TO TAI_VU;
...
------------------------------------------------------------------------ CAU 3 ------------------------------------------------------------------------
-- BOI CANH: BENH VIEN TACH RA 1 CHI NHANH KHAC O QUAN 10 VA 1/2 NHAN VIEN PHAI SANG DO LAM VIEC. NGO�I RA BENH VIEN C� NHU CAU LUU LAI C�C CUOC HOP CUA C�C NH�N VI�N VA NHUNG TH�NG TIN CUA CUOC HOP CUA QU�N L� 
-- TH� NH�N VI�N KH�NG DUOCC QUYEN NH�N THAY, NGO�I RA C�C NH�N VI�N CHI DUOC XEM TH�NG TIN NHUNG CUOC HOP THUOC PH�NG BAN CUA M�NH V� THUOC CHI NH�NH CUA M�NH
...
-- DOAN CODE N�Y N�N LOG IN V�O SQL PLUS BANG ACCOUNT LBACSYS/"123" V� CH�P DOAN CODE GRANT DUOI DOAN COMMENT N�Y DE DBA_USER C� DUOC NHUNG QUYEN CAN THIET
...
-------------------------------------------------------------
----- G�N NH�N CHO TUNG D�NG DU LIEU BANG C�U UPDATE --------
-------------------------------------------------------------
...
--- DOI OPTION TABLE CONTROL TH�NH READ - CONTROL
BEGIN 
