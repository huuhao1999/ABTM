...
CREATE ROLE TAI_VU;
--TAO VIEW TAI_VU_VIEW
CREATE VIEW NHANVIEN_TAI_VU_VIEW AS
SELECT DT.ID_DIEUTRI, DT.MABENHNHAN, DT.MANV AS BACSI,  DV.TENDV, DSDV.ID_SUDUNGDICHVU, DSDV.GIATIEN
FROM DBA_USER.DIEU_TRI DT,DBA_USER.DANH_SACH_SU_DUNG_DICH_VU DSDV,DBA_USER.DICH_VU_KHAM_BENH DV
WHERE DT.ID_DIEUTRI=DSDV.ID_DIEUTRI AND DSDV.MADV=DV.MADV ORDER BY DT.ID_DIEUTRI;
/
GRANT SELECT ON DBA_USER.NHANVIEN_TAI_VU_VIEW TO TAI_VU;
...
GRANT UPDATE,SELECT ON DBA_USER.BENH_NHAN TO BAC_SI;
