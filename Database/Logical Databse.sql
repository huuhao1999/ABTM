...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE DBA_USER.BENH_NHAN CASCADE CONSTRAINTS';
...
/ BEGIN EXECUTE IMMEDIATE 'DROP TABLE DBA_USER.CUOC_HOP CASCADE CONSTRAINTS';
...
/ BEGIN EXECUTE IMMEDIATE 'DROP USER QL001';
...
/ BEGIN EXECUTE IMMEDIATE 'DROP ROLE TIEP_TAN';
...
grant
select
    on sys.objauth $ to DBA_USER;

grant
select
    on sys.obj $ to DBA_USER;

grant
select
    on sys.user $ to DBA_USER;

grant
select
    on sys.col $ to DBA_USER;

grant
select
    on table_privilege_map to DBA_USER;
...
ALTER TABLE
    DANH_SACH_DON_THUOC
ADD
    CONSTRAINT "DUOC MUA TRONG" FOREIGN KEY (MATHUOC) REFERENCES THUOC (MATHUOC);

ALTER TABLE
    DANH_SACH_DON_THUOC
ADD
    CONSTRAINT CO FOREIGN KEY (MADT) REFERENCES DONTHUOC (MADT) ON DELETE CASCADE;

ALTER TABLE
    DANH_SACH_SU_DUNG_DICH_VU
ADD
    CONSTRAINT "DUOC SU DUNG" FOREIGN KEY (MADV) REFERENCES DICH_VU_KHAM_BENH (MADV) ON DELETE CASCADE;

ALTER TABLE
    DANH_SACH_SU_DUNG_DICH_VU
ADD
    CONSTRAINT "SU DUNG" FOREIGN KEY (ID_DIEUTRI) REFERENCES DIEU_TRI (ID_DIEUTRI) ON DELETE CASCADE;

ALTER TABLE
    DIEU_TRI
ADD
    CONSTRAINT "PHU TRACH" FOREIGN KEY (MANV) REFERENCES NHANVIEN (MANV);

ALTER TABLE
    DIEU_TRI
ADD
    CONSTRAINT "THAM GIA" FOREIGN KEY (MABENHNHAN) REFERENCES BENH_NHAN (MABENHNHAN) ON DELETE CASCADE;

ALTER TABLE
    DONTHUOC
ADD
    CONSTRAINT "CHI DINH " FOREIGN KEY (ID_DIEUTRI) REFERENCES DIEU_TRI (ID_DIEUTRI);

ALTER TABLE
    NHANVIEN
ADD
    CONSTRAINT THUOC FOREIGN KEY (MAPB) REFERENCES PHONG_BAN (MAPB) ON DELETE CASCADE;

ALTER TABLE
    TRUC_PHONG_KHAM
ADD
    CONSTRAINT TRUC FOREIGN KEY (MANV) REFERENCES NHANVIEN (MANV) ON DELETE CASCADE;
...
VALUES
    (1, 1, 'QUAN LI 1', 0, 'QL001', 7000000, 500000);
...
VALUES
    (2, 1, 'QUAN LI 2', 0, 'QL002', 7000000, 500000);
...
VALUES
    (3, 1, 'QUAN LI 3', 0, 'QL003', 7000000, 500000);
...
VALUES
    (4, 2, 'TAI VU 1', 0, 'TV001', 4000000, 200000);
...
VALUES
    (5, 2, 'TAI VU 2', 0, 'TV002', 4000000, 200000);
...
VALUES
    (6, 3, 'KE TOAN 1', 0, 'KT001', 4000000, 200000);
...
VALUES
    (7, 3, 'KE TOAN 2', 0, 'KT002', 4000000, 200000);
...
VALUES
    (8, 4, 'TIEP TAN 1', 0, 'TT001', 4000000, 200000);
...
VALUES
    (9, 4, 'TIEP TAN 2', 0, 'TT002', 4000000, 200000);
...
VALUES
    (10, 5, 'BAN THUOC 1', 0, 'BT001', 4000000, 200000);
...
VALUES
    (11, 5, 'BAN THUOC 2', 0, 'BT002', 4000000, 200000);
...
VALUES
    (12, 6, 'BAC SI 1', 1, 'BS001', 10000000, 500000);
...
VALUES
    (13, 6, 'BAC SI 2', 1, 'BS002', 10000000, 500000);
...
/*==============================================================*/
INSERT INTO
    TRUC_PHONG_KHAM(MANV, THOIGIANBATDAUTRUC)
VALUES
    (5, CURRENT_DATE -7);
...
VALUES
    (1, 'THUOC DAU BUNG', 5000);

INSERT INTO
    THUOC(MATHUOC, TENTHUOC, GIATHUOC)
VALUES
    (2, 'THUOC DAU DAU', 10000);

INSERT INTO
    THUOC(MATHUOC, TENTHUOC, GIATHUOC)
VALUES
    (3, 'THUOC CHUA HO', 20000);

INSERT INTO
    THUOC(MATHUOC, TENTHUOC, GIATHUOC)
VALUES
    (4, 'THUOC CHUA DAU HONG', 8000);

INSERT INTO
    THUOC(MATHUOC, TENTHUOC, GIATHUOC)
VALUES
    (5, 'THUOC CHUA CHONG MAT', 10000);

INSERT INTO
    THUOC(MATHUOC, TENTHUOC, GIATHUOC)
VALUES
    (6, 'THUOC CHUA GAY XUONG', 10000);
...
/*==============================================================*/
INSERT INTO
    DICH_VU_KHAM_BENH(MADV, TENDV, GIADV)
VALUES
    (1, 'X-QUANG', 10000);
...
/*==============================================================*/
INSERT INTO
    DIEU_TRI(ID_DIEUTRI, MABENHNHAN, MANV, THOIGIANKHAM)
VALUES
    (1, 1, 12, CURRENT_DATE - 7);

INSERT INTO
    DIEU_TRI(ID_DIEUTRI, MABENHNHAN, MANV, THOIGIANKHAM)
VALUES
    (2, 2, 12, CURRENT_DATE - 6);

INSERT INTO
    DIEU_TRI(ID_DIEUTRI, MABENHNHAN, MANV, THOIGIANKHAM)
VALUES
    (3, 3, 13, CURRENT_DATE - 5);

INSERT INTO
    DIEU_TRI(ID_DIEUTRI, MABENHNHAN, MANV, THOIGIANKHAM)
VALUES
    (4, 4, 13, CURRENT_DATE - 4);

INSERT INTO
    DIEU_TRI(ID_DIEUTRI, MABENHNHAN, MANV, THOIGIANKHAM)
VALUES
    (5, 5, 12, CURRENT_DATE - 3);
...
/*==============================================================*/
INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (4, 1, CURRENT_DATE - 7, 40000);

INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (2, 2, CURRENT_DATE - 6, 20000);

INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (3, 2, CURRENT_DATE - 6, 30000);

INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (1, 3, CURRENT_DATE - 5, 10000);

INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (4, 4, CURRENT_DATE - 4, 40000);

INSERT INTO
    DANH_SACH_SU_DUNG_DICH_VU(MADV, ID_DIEUTRI, NGAYTHANG, GIATIEN)
VALUES
    (4, 5, CURRENT_DATE - 4, 40000);
...
/*==============================================================*/
INSERT INTO
    DONTHUOC(MADT, ID_DIEUTRI, NGAYLAP, TONGGIA)
VALUES
    (1, 1, CURRENT_DATE - 7, 30000);

INSERT INTO
    DONTHUOC(MADT, ID_DIEUTRI, NGAYLAP, TONGGIA)
VALUES
    (2, 2, CURRENT_DATE - 6, 30000);

INSERT INTO
    DONTHUOC(MADT, ID_DIEUTRI, NGAYLAP, TONGGIA)
VALUES
    (3, 3, CURRENT_DATE - 5, 30000);

INSERT INTO
    DONTHUOC(MADT, ID_DIEUTRI, NGAYLAP, TONGGIA)
VALUES
    (4, 4, CURRENT_DATE - 4, 15000);

INSERT INTO
    DONTHUOC(MADT, ID_DIEUTRI, NGAYLAP, TONGGIA)
VALUES
    (5, 5, CURRENT_DATE - 3, 15000);
...
/*==============================================================*/
INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (1, 1, 1, 1999, 28, 7500000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (2, 1, 2, 1999, 26, 7000000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (3, 2, 1, 1999, 25, 6800000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (4, 2, 2, 1999, 27, 7400000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (5, 3, 1, 1999, 29, 7500000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (6, 3, 2, 1999, 29, 7500000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (7, 4, 1, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (8, 4, 2, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (9, 5, 1, 1999, 27, 4000000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (10, 5, 2, 1999, 24, 3200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (11, 6, 1, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (12, 6, 2, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (13, 7, 1, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (14, 7, 2, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (15, 8, 1, 1999, 28, 4100000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (16, 8, 2, 1999, 28, 4100000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (17, 9, 1, 1999, 27, 400000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (18, 9, 2, 1999, 26, 3900000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (19, 10, 1, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (20, 10, 2, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (21, 11, 1, 1999, 28, 4100000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (22, 11, 2, 1999, 29, 4200000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (23, 12, 1, 1999, 29, 15000000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (24, 12, 2, 1999, 29, 15000000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (25, 13, 1, 1999, 29, 15000000);

INSERT INTO
    LUONG(ID_LUONG, MANV, THANG, NAM, SONGAYCONG, LUONG)
VALUES
    (26, 13, 2, 1999, 29, 15000000);
...
,
    DELETE,
UPDATE
    ON DBA_USER.PHONG_BAN TO QUAN_LI_TAI_NGUYEN;
...
,
    DELETE,
UPDATE
    ON DBA_USER.NHANVIEN TO QUAN_LI_TAI_NGUYEN;
...
,
    DELETE,
UPDATE
    ON DBA_USER.TRUC_PHONG_KHAM TO QUAN_LI_TAI_NGUYEN;

GRANT
SELECT
    ON DBA_USER.LUONG TO QUAN_LI_TAI_NGUYEN;

/ CREATE ROLE QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.THUOC TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.DICH_VU_KHAM_BENH TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.NHANVIEN TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.DIEU_TRI TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.TRUC_PHONG_KHAM TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.PHONG_BAN TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.DONTHUOC TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.DANH_SACH_DON_THUOC TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.DANH_SACH_SU_DUNG_DICH_VU TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON DBA_USER.LUONG TO QUAN_LI_TAI_VU;

/ CREATE ROLE QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.THUOC TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.DICH_VU_KHAM_BENH TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.NHANVIEN TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.DIEU_TRI TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.TRUC_PHONG_KHAM TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.PHONG_BAN TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.DONTHUOC TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.DANH_SACH_DON_THUOC TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.DANH_SACH_SU_DUNG_DICH_VU TO QUAN_LI_CHUYEN_MON;

GRANT
SELECT
    ON DBA_USER.LUONG TO QUAN_LI_CHUYEN_MON;
...
,
    DELETE,
UPDATE
    ON DBA_USER.BENH_NHAN TO TIEP_TAN;
...
,
UPDATE
    ON DBA_USER.DIEU_TRI TO TIEP_TAN;

/ CREATE ROLE TAI_VU;

GRANT
SELECT
    ON DBA_USER.DICH_VU_KHAM_BENH TO TAI_VU;

GRANT
UPDATE
(GIADV) ON DBA_USER.DICH_VU_KHAM_BENH TO TAI_VU;

GRANT
SELECT
    ON DBA_USER.DANH_SACH_SU_DUNG_DICH_VU TO TAI_VU;

GRANT
UPDATE
(GIATIEN) ON DBA_USER.DANH_SACH_SU_DUNG_DICH_VU TO TAI_VU;
...
,
UPDATE
(TONGGIA) ON DBA_USER.DONTHUOC TO BAN_THUOC;

GRANT
SELECT
,
UPDATE
(DONGIA) ON DBA_USER.DANH_SACH_DON_THUOC TO BAN_THUOC;

GRANT
SELECT
    ON DBA_USER.THUOC TO BAN_THUOC;

/ CREATE ROLE KE_TOAN;

GRANT
SELECT
    ON DBA_USER.NHANVIEN TO KE_TOAN;
...
,
UPDATE
    ON DBA_USER.DIEU_TRI TO BAC_SI;

GRANT
SELECT
,
UPDATE
(MADT, ID_DIEUTRI, NGAYLAP),
INSERT
,
    DELETE ON DBA_USER.DONTHUOC TO BAC_SI;

GRANT
SELECT
,
UPDATE
(ID_DANHSACHDONTHUOC, MADT, MATHUOC, SOLUONG),
INSERT
,
    DELETE ON DBA_USER.DANH_SACH_DON_THUOC TO BAC_SI;
...
CREATE
OR REPLACE FUNCTION FUNC_DIEUTRI_BACSI (p_schema varchar2, p_obj varchar2) Return varchar2 as MaNV INT;

LaBacSi INT;

BEGIN BEGIN
SELECT
    LABACSI INTO LaBacSi
FROM
    DBA_USER.NHANVIEN
WHERE
...
EXCEPTION
WHEN NO_DATA_FOUND THEN LaBacSi := 0;
...
EXCEPTION
WHEN NO_DATA_FOUND THEN MaNV := 0;

END;

if (LaBacSi = 1) then return 'MANV = ' || MaNV;
...
CREATE
OR REPLACE FUNCTION FUNC_DONTHUOC_BACSI (p_schema varchar2, p_obj varchar2) RETURN VARCHAR2 AS MaNV INT;
...
if (
    LaBacSi = 1
    and MaNV <> 0
) then return 'ID_DIEUTRI IN ( SELECT ID_DIEUTRI FROM DIEU_TRI WHERE MANV = ' || MaNV || ')';
...
CREATE
OR REPLACE FUNCTION FUNC_DANHSACHDONTHUOC_BACSI (p_schema varchar2, p_obj varchar2) RETURN VARCHAR2 AS MaNV INT;
...
if (
    LaBacSi = 1
    and MaNV <> 0
) then return 'MADT IN ( SELECT MADT FROM DONTHUOC WHERE ID_DIEUTRI IN (SELECT ID_DIEUTRI FROM DIEU_TRI WHERE MANV = ' || MaNV || '))';
...
/ ------------------------------------------------------------------------ CAU 3 ------------------------------------------------------------------------
-- BOI CANH: BENH VIEN TACH RA 1 CHI NHANH KHAC O QUAN 10 VA 1/2 NHAN VIEN PHAI SANG DO LAM VIEC. NGO�I RA B?NH VI?N C� NHU C?U L?U L?I C�C CU?C H?P C?A C�C NH�N VI�N NH?NG NH?NG TH�NG TIN C?A CU?C H?P C?A QU�N L� 
-- TH� NH�N VI�N KH�NG ???C QUY?N NH�N TH?Y, NGO�I RA C�C NH�N VI�N CH? ???C XEM TH�NG TIN NH?NG CU?C H?P THU?C PH�NG BAN C?A M�NH V� THU?C CHI NH�NH C?A M�NH
...
ALTER TABLE
    CUOC_HOP
ADD
    CONSTRAINT FK_CUOC_HOP_NHANVIEN FOREIGN KEY (MANVCHUTRI) REFERENCES NHANVIEN (MANV) ON DELETE
SET
    NULL;

INSERT INTO
    CUOC_HOP(MAHOP, NOIDUNGHOP, THOIGIANHOP, MANVCHUTRI)
VALUES
    (1, 'TINH LUONG Q5', CURRENT_DATE - 7, 6);
...
VALUES
    (
        2,
        'TONG HOP LAI THANH TOAN CUA BENH NHAN Q5',
        CURRENT_DATE - 7,
        4
    );
...
VALUES
    (
        3,
        'PHO BIEN NOI DUNG TIEP DON BENH NHAN Q5',
        CURRENT_DATE - 7,
        8
    );
...
VALUES
    (
        4,
        'PHO BIEN CACH SAP XEP KE THUOC Q5',
        CURRENT_DATE - 7,
        10
    );
...
VALUES
    (
        5,
        'HOP PHAC DO DIEU TRI COVID-20 Q5',
        CURRENT_DATE - 7,
        12
    );
...
INSERT INTO
    CUOC_HOP(MAHOP, NOIDUNGHOP, THOIGIANHOP, MANVCHUTRI)
VALUES
    (6, 'TINH LUONG Q10', CURRENT_DATE - 7, 7);
...
VALUES
    (
        7,
        'TONG HOP LAI THANH TOAN CUA BENH NHAN Q10',
        CURRENT_DATE - 7,
        5
    );
...
VALUES
    (
        8,
        'PHO BIEN NOI DUNG TIEP DON BENH NHAN Q10',
        CURRENT_DATE - 7,
        9
    );
...
VALUES
    (
        9,
        'PHO BIEN CACH SAP XEP KE THUOC Q10',
        CURRENT_DATE - 7,
        11
    );
...
VALUES
    (
        10,
        'HOP PHAC DO DIEU TRI COVID-20 Q10',
        CURRENT_DATE - 7,
        13
    );
...
INSERT INTO
    CUOC_HOP(MAHOP, NOIDUNGHOP, THOIGIANHOP, MANVCHUTRI)
VALUES
    (11, 'HOP NHAN SU CAP CAO Q5', CURRENT_DATE - 7, 1);
...
VALUES
    (
        13,
        'HOP THUONG NIEN CAP CAO GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        3
    );
...
VALUES
    (
        14,
        'HOP THUONG NIEN BO PHAN KE TOAN GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        6
    );
...
VALUES
    (
        15,
        'HOP THUONG NIEN BO PHAN TIEP TAN GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        8
    );
...
VALUES
    (
        16,
        'HOP THUONG NIEN BO PHAN TAI VU GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        4
    );
...
VALUES
    (
        17,
        'HOP THUONG NIEN BO PHAN BAN THUOC GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        10
    );
...
VALUES
    (
        18,
        'HOP THUONG NIEN BO PHAN BAC SI GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        12
    );
...
VALUES
    (
        19,
        'HOP THUONG NIEN LIEN BO PHAN GIUA CAC CHI NHANH',
        CURRENT_DATE - 7,
        13
    );
...
/ GRANT
SELECT
    ON CUOC_HOP TO BAC_SI;

GRANT
SELECT
    ON CUOC_HOP TO TIEP_TAN;

GRANT
SELECT
    ON CUOC_HOP TO TAI_VU;

GRANT
SELECT
    ON CUOC_HOP TO BAN_THUOC;

GRANT
SELECT
    ON CUOC_HOP TO KE_TOAN;

GRANT
SELECT
    ON CUOC_HOP TO QUAN_LI_TAI_NGUYEN;

GRANT
SELECT
    ON CUOC_HOP TO QUAN_LI_TAI_VU;

GRANT
SELECT
    ON CUOC_HOP TO QUAN_LI_CHUYEN_MON;
...
-- ?O?N CODE N�Y N�N LOG IN V�O SQL PLUS B?NG ACCOUNT LBACSYS/"123" V� CH�P ?O?N CODE GRANT D??I ?O?N COMMENT N�Y ?? DBA_USER C� ???C NH?NG QUY?N C?N THI?T
...
------ DROP GROUP FIRST --------------------------
--------------------------------------------------
BEGIN SA_COMPONENTS.DROP_GROUP (
    policy_name = > 'HOP_OLS',
    group_num = > 200
);
...
/ -------------------------------------------------------------
----- G�N NH�N CHO T?NG D�NG D? LI?U B?NG C�U UPDATE --------
-------------------------------------------------------------
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:KT:Q5')
WHERE
    MAHOP = 1;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TV:Q5')
WHERE
    MAHOP = 2;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TT:Q5')
WHERE
    MAHOP = 3;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BT:Q5')
WHERE
    MAHOP = 4;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BS:Q5')
WHERE
    MAHOP = 5;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:KT:Q10')
WHERE
    MAHOP = 6;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TV:Q10')
WHERE
    MAHOP = 7;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TT:Q10')
WHERE
    MAHOP = 8;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BT:Q10')
WHERE
    MAHOP = 9;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BS:Q10')
WHERE
    MAHOP = 10;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'QL:BS,TV,KT,BT,TT:Q5')
WHERE
    MAHOP = 11;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'QL:BS,TV,KT,BT,TT:Q10')
WHERE
    MAHOP = 12;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'QL')
WHERE
    MAHOP = 13;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:KT')
WHERE
    MAHOP = 14;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TT')
WHERE
    MAHOP = 15;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:TV')
WHERE
    MAHOP = 16;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BT')
WHERE
    MAHOP = 17;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV:BS')
WHERE
    MAHOP = 18;
...
UPDATE
    DBA_USER.CUOC_HOP
SET
    ROWLABEL = CHAR_TO_LABEL('HOP_OLS', 'NV::Q5,Q10')
WHERE
    MAHOP = 19;
...
/ --- ??I OPTION TABLE CONTROL TH�NH READ - CONTROL
BEGIN SA_POLICY_ADMIN.REMOVE_TABLE_POLICY -- DROP COLUMN DEFAULT = FALSE
(
    policy_name = > 'HOP_OLS',
    schema_name = > 'DBA_USER',
    table_name = > 'CUOC_HOP'
